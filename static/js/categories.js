...
$('#renameModal').on('show.bs.modal', function (event) {
    ...
    var budgets_string = button.data('budgets') // Get the semi-colon delimitted string of budgets that are associated with the category
    var budgets = budgets_string.split(";")
    var modal = $(this)
    ...
    if (budgets.length > 1) {
        msg[0].innerText = "The following budgets will be updated to the new name:";
